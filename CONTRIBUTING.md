...
If you've found a bug, please create an [issue](https://github.com/panjiang/overseer/issues) or if possible, create a fix and send in a pull request.
...
* In **both** cases, each will need to ship with a corresponding CLI tool, this tool:
  ...
  * Optionally sign binaries
      ...
      * Embed public keys into the binaries with
        ...
        ```
        -ldflags "-X github.com/panjiang/overseer/fetcher.PublicKey=A" -o myapp
        ```
